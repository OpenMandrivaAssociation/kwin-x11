...
%if 0%{?git:1}
Source0:	https://invent.kde.org/plasma/kwin/-/archive/%{gitbranch}/kwin-x11-%{gitbranchd}.tar.bz2#/kwin-%{git}.tar.bz2
%else
Source0: http://download.kde.org/%{stable}/plasma/%{plasmaver}/kwin-x11-%{version}.tar.xz
%endif
